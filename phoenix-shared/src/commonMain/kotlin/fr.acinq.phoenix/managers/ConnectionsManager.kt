...
data class Connections(
    val internet: Connection = Connection.CLOSED(null),
    val peer: Connection = Connection.CLOSED(null),
    val electrum: Connection = Connection.CLOSED(null)
) {
            ...
            combine(
                ...
                Connections(
                    ...
                    internet = when (internetState) {
                        ...
                        NetworkState.NotAvailable -> Connection.CLOSED(null)
                    }
                )
            }.collect {
